...
class Booking
{
    ...
    public function isBookableDates() {
        // 1) Il faut connaître les dates non disponibles pour l'annonce
        $notAvailableDays = $this->ad->getNotAvailableDays();
        // 2) Il faut comparer les dates choisies avec les non dispo
        ...
        // Tableau qui contient des chaines de caratères de mes journées
