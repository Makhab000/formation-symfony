 ...
 * @UniqueEntity(
 *  fields={"title"},
 *  message="Un autre titre correspond, veuillez le remplacer"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit comporter au moins 10 caractères minimum", 
     * maxMessage="Le titre doit compter 255 caractères maximum" )
     */
    private $title;
     ...
     * @Assert\Length(min=20, minMessage="Veuillez saisir une introduction de 20 caractères minimum")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Veuilez saisir une description de 100 caractères minimum")
     */
    private $content;
